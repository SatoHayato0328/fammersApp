            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\YoteiController@create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="yotei_date" value="{{ old('yotei_date') }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-10">作業時間</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="yotei_time" value="{{ old('yotei_time') }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-10">作業人数</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="yotei_people" value="{{ old('yotei_people') }}">
                        </div>
                    </div>
                    <div class="form-group row">
